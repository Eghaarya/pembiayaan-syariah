...
return new class extends Migration
{
    ...
    {
        Schema::create('murabahah_limac_capital_tb_aset_tanahbangunans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('kode_pengajuan', 'fk_murabahah_aset_tanahbangunan')
    ...
    {
        Schema::dropIfExists('murabahah_limac_capital_tb_aset_tanahbangunans');
    }
};

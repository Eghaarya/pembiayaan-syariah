...
return new class extends Migration
{
    ...
    {
        Schema::create('murabahah_limac_collateral_bermotors', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('teknologi', 100)->nullable();
    ...
    {
        Schema::dropIfExists('murabahah_limac_collateral_bermotors');
    }
};

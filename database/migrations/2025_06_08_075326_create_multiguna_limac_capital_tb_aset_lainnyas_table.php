...
return new class extends Migration
{
    ...
    {
        Schema::create('multiguna_limac_capital_tb_aset_lainnyas', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('kode_pengajuan', 'fk_multiguna_aset_lainnya')
    ...
    {
        Schema::dropIfExists('multiguna_limac_capital_tb_aset_lainnyas');
    }
};

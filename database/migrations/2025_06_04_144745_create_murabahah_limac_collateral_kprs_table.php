...
return new class extends Migration
{
    ...
    {
        Schema::create('murabahah_limac_collateral_kprs', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('kondisi_wilayah_agunan', 200)->nullable();
    ...
    {
        Schema::dropIfExists('murabahah_limac_collateral_kprs');
    }
};

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nasabah_pekerjaan', function (Blueprint $table) {
            ...
            $table->date('penggajian_satu_nasabah')->nullable();
            $table->date('penggajian_dua_nasabah')->nullable();
            ...
            $table->date('penggajian_satu_pasangan')->nullable();
            $table->date('penggajian_dua_pasangan')->nullable();

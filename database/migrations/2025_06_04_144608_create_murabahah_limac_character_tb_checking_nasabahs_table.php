...
return new class extends Migration
{
    ...
    {
        Schema::create('murabahah_limac_character_tb_checking_nasabahs', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('kode_pengajuan', 'fk_murabahah_checking_nasabah')
    ...
    {
        Schema::dropIfExists('murabahah_limac_character_tb_checking_nasabahs');
    }
};

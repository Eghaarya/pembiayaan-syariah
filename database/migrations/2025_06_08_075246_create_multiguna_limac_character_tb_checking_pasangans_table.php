...
return new class extends Migration
{
    ...
    {
        Schema::create('multiguna_limac_character_tb_checking_pasangans', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('kode_pengajuan', 'fk_multiguna_checking_pasangan')
    ...
    {
        Schema::dropIfExists('multiguna_limac_character_tb_checking_pasangans');
    }
};

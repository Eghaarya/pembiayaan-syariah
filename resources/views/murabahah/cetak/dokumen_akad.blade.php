...
<body contenteditable="true" spellcheck="false" class="bg-white text-dark">
    ...
    <div class="container p-5">
        ...
        <h6 class="text-center font-weight-bold mb-1">
            AKAD PEMBIAYAAN KPR atau KPM iB BAROKAH
        </h6>
        ...
        <div class="text-center">
            <input type="text" class="form-control text-center bg-white text-danger border-0 font-weight-bold w-100"
                value="{{ 'Nomor: ' . sprintf('%04d', $pengajuan->id ?? 0) . '/' . strtoupper($nasabah_profil->nama_nasabah ?? '-') . '/KPR/KPM/SYARIAH' }}">
        </div>
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            ...
            sebagai berikut :
            <br><br>
            1.  Bahwa PIHAK KEDUA telah mengajukan permohonan fasilitas pembiayaan KPR/KPM syariah kepada PIHAK PERTAMA
            ...
            Berdasarkan keterangan diatas PARA PIHAK sepakat untuk mengikatkan diri dalam AKAD PEMBIAYAAN KPR/KPM iB
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            1.PIHAK PERTAMA menyetujui menyediakan fasilitas pembiayaan KPR/KPM konsumtif berdasarkan prinsip
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            - PEMBIAYAAN KPR/KPM/Harga Beli PIHAK PERTAMA
            <br>
        </div>
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            1. PIHAK KEDUA diperkenankan melakukan pelunasan Pembiayaan KPR/KPM seluruhnya bersama-sama dengan kewajiban
        ...
        {{-- Jaminan --}}
        <div class="row align-items-center font-weight-bold my-0 py-0 px-4">
            <label class="col-6 col-form-label mb-0">Jaminan jika KPR</label>
            <label class="col-6 col-form-label mb-0">Jaminan jika KPM</label>
        </div>

        <div class="row mt-0 mb-2 py-0 px-4">
            <!-- KPR -->
            <div class="col-5">
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Nomor Sertifikat</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="nomor_sertifikat"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralkpr->nomor_sertifikat ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Tanggal Penerbitan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="date" name="tanggal_penerbitan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ \Carbon\Carbon::parse($pengajuan_collateralkpr->tanggal_penerbitan)->format('Y-m-d') }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Nama Pemegang Hak</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="nama_pemegang_hak"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralkpr->nama_pemegang_hak ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Lama & Tgl Akhir Hak</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="lama_akhir_hak"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralkpr->lama_tgl_akhir_hak_berlaku ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Letak Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="letak_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralkpr->letak_agunan ?? '' }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-7">
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Jenis Kendaraan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <select name="jenis_kendaraan" id="jenis_kendaraan"
                            ...
                            @endphp
                            @foreach ($jenis_kendaraan_options as $option)
                                <option value="{{ $option }}"
                                    {{ old('jenis_kendaraan', $pengajuan_collateralkpr->jenis_kendaraan ?? '') == $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Status Agunan Kendaraan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <select name="status_agunan_kendaraan" id="status_agunan_kendaraan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold">
                            @php
                                $status_agunan_options = ['--', 'Baru (2)', 'Lama (1)'];
                            @endphp
                            @foreach ($status_agunan_options as $option)
                                <option value="{{ $option }}"
                                    {{ old('status_agunan_kendaraan', $pengajuan_collateralkpr->status_agunan_kendaraan ?? '') == $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Nomor STNK Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="nomor_stnk_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->nomor_stnk_agunan ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Nama Pemilik Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="nama_pemilik_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->nama_pemilik_agunan ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Merk Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="merk_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->merk_agunan ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Tipe Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <select name="tipe_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold">
                            @php
                                $tipeOptions = [
                                    '--',
                            ...
                            @foreach ($tipeOptions as $option)
                                <option value="{{ $option }}"
                                    {{ $pengajuan_collateralbermotor->tipe_agunan == $option ? 'selected' : '' }}>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Teknologi</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <select name="teknologi"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold">
                            @php $teknologiOptions = ['--', 'Manual', 'Matic']; @endphp
                            @foreach ($teknologiOptions as $option)
                                <option value="{{ $option }}"
                                    {{ $pengajuan_collateralbermotor->teknologi == $option ? 'selected' : '' }}>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Bahan Bakar</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <select name="bahan_bakar"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold">
                            @php $bahanBakarOptions = ['--', 'Pertamax (3)', 'Solar (1)', 'Pertalite (2)', 'Listrik']; @endphp
                            @foreach ($bahanBakarOptions as $option)
                                <option value="{{ $option }}"
                                    {{ $pengajuan_collateralbermotor->bahan_bakar == $option ? 'selected' : '' }}>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Warna Agunan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="warna_agunan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->warna_agunan ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Isi Silinder</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="isi_silinder"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->isi_silinder ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Tahun Pembuatan</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="tahun_pembuatan"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->tahun_pembuatan ?? '' }}">
                    </div>
                </div>

                <div class="form-group row align-items-center my-0 py-0">
                    <label class="col-3 col-form-label mb-0">Masa Berlaku</label>
                    <div class="col-1 text-right px-0">:</div>
                    <div class="col-8">
                        <input type="text" name="masa_berlaku"
                            class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                            value="{{ $pengajuan_collateralbermotor->masa_berlaku ?? '' }}">
                    </div>
                </div>
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            ...
            pemberian fasilitas pembiayaan KPR/KPM konsumtif adalah palsu, tidak sah, atau tidak benar.<br>
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            ...
            pembiayaan atau selama jumlah seluruh kewajiban pembiayaan KPR/KPM yang diberikan oleh PIHAK PERTAMA kepada
        ...
        <div class="form-control mt-5 pt-5 mb-3 pb-3 bg-white border-0" style="text-align: justify; resize: none;">
            Lampiran 9. Akad Pembiayaan KPR/KPM iB Barokah Berdasarkan Prinsip Ijarah
        </div>
        <h6 class="text-center font-weight-bold mb-1">
            AKAD PEMBIAYAAN KPR/KPM iB BAROKAH
        </h6>
        <h6 class="text-center font-weight-bold mb-3">
        ...
        <div class="form-control bg-white border-0" style="text-align: center; resize: none;">
            1.    PIHAK PERTAMA menyetujui menyediakan fasilitas pembiayaan KPR/KPM konsumtif berdasarkan prinsip Ijarah
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            1. PIHAK KEDUA diperkenankan melakukan pelunasan Pembiayaan KPR/KPM seluruhnya bersama-sama dengan
        ...
        <div class="form-control bg-white border-0" style="text-align: justify; resize: none;">
            ...
            pembiayaan atau selama jumlah seluruh kewajiban pembiayaan KPR/KPM yang diberikan oleh PIHAK PERTAMA

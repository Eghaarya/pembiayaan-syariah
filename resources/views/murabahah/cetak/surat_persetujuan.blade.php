...
<body contenteditable="true" spellcheck="false" class="bg-white text-dark">
    ...
    <div class="container p-5">
        ...
        <h6 class="text-center border-bottom font-weight-bold py-2">SURAT PERSETUJUAN PEMBIAYAAN </h6>
        <span>Kepada Yth,</span>
        <div class="form-group row align-items-center my-0 py-0">
            <label for="nama_nasabah" class="col-2 col-form-label mb-0">Nama Nasabah</label>
        ...
        <div class="form-group row my-0 py-0">
            <label for="alamat_nasabah" class="col-2 col-form-label mb-0">Alamat Nasabah</label>
            <div class="col-1 text-right px-0">:</div>
            <div class="col-9">
                <textarea id="alamat_nasabah" name="alamat_nasabah"
                    class="form-control p-0 bg-white text-danger border-0 font-weight-bold" rows="2">{{ $nasabah_profil->alamat_ktp_nasabah ?? '' }}</textarea>
            </div>
        </div>

        <div>
            <p class="my-1">Assalamu’alaikum Warahmatullahi Wabarakatuh,</p>
            <p class="my-1">
                Menunjuk pada surat permohonan pembiayaan <span class="font-weight-bold">KPR (Kredit Pembelian Rumah)
                    atau
                    KPM (Kredit Pemilikan Motor)</span>
                Saudara, dengan ini diberitahukan bahwa Bank Syariah UMSIDA dapat memberikan pembiayaan kepada nasabah
        ...
        {{-- Pembiayaan --}}
        <div class="form-group row align-items-center my-0 py-0">
            <label for="keputusan_jenis_akad" class="col-2 col-form-label mb-0">Jenis Akad</label>
            <div class="col-1 text-right px-0">:</div>
            <div class="col-9">
                <input type="text" id="keputusan_jenis_akad" name="keputusan_jenis_akad"
                    class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
        ...
        <div class="form-group row align-items-center my-0 py-0">
            <label for="keputusan_jenis_pembiayaan" class="col-2 col-form-label mb-0">Jenis Pembiayaan</label>
            <div class="col-1 text-right px-0">:</div>
            <div class="col-9">
                <select class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                    id="keputusan_jenis_pembiayaan" name="keputusan_jenis_pembiayaan">
                    @php
                        $options = ['--', 'Pembiayaan rumah (KPR)', 'Pembiayaan Kendaraan Bermotor (PKB)'];
                        $selected = old('keputusan_jenis_pembiayaan', $pengajuan->keputusan_jenis_pembiayaan ?? '');
                    @endphp
        ...
        <div class="form-group row my-0 py-0 align-items-center">
        ...
        <div class="row border-bottom mt-0 mb-2 py-0">
            <!-- KPR -->
            <div class="col-5">
                <div class="form-group row align-items-center my-0 py-0">

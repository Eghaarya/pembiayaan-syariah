                                    ...
                                    <div class="tab-content p-3" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    @php
                                                        $skalaOptions = [
                                                            'internasional' => 'INTERNASIONAL (Penanaman Modal Asing)',
                                                            'nasional' => 'NASIONAL (Aset min 200 jt, Omset 10 M/th)',
                                                            'umkm' => 'UMKM (Aset <200jt, Omset ± 1 M/th)',
                                                        ];
                                                    ...
                                                    <select disabled class="form-control border-0 bg-white text-dark"
                                                        ...
                                                        <option value="">-- Pilih Skala Perusahaan --</option>
                                                        @foreach ($skalaOptions as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ $selectedSkala === $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    @php
                                                        $jabatanOptions = [
                                                            'karyawan_lini_bawah' => 'Karyawan Lini Bawah',
                                                            'karyawan_lini_tengah_manager' =>
                                                                'Karyawan Lini Tengah / Manager',
                                                            'karyawan_lini_atas_direktu' =>
                                                    ...
                                                    <select disabled class="form-control border-0 bg-white text-dark"
                                                        ...
                                                        @foreach ($jabatanOptions as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ $selectedJabatan === $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <select disabled class="form-control border-0 bg-white text-dark"
                                                        ...
                                                        <option value="">-- Pilih Pengalaman --</option>
                                                        @foreach ($pengalamanOptions as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ $selectedPengalaman == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    @foreach ($pendidikanOptions as $value => $label)
                                                        <div class="form-check form-check-inline">
                                                            <input disabled class="form-check-input" type="radio"
                                                                ...
                                                                id="pendidikan{{ strtoupper(preg_replace('/[^a-zA-Z0-9]/', '', $value)) }}"
                                                                value="{{ $value }}"
                                                                {{ $pendidikan == $value ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="pendidikan{{ strtoupper(preg_replace('/[^a-zA-Z0-9]/', '', $value)) }}">
                                                                {{ $label }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                                ...
                                                <div class="col-md-3 mt-2">
                                                    ...
                                                    @php
                                                        $usiaNasabahOptions = [
                                                            ...
                                                            '41 - 50 th' => '41 - 50 th',
                                                            '51 - 60 th' => '51 - 60 th',
                                                            'lebih dari 60 th' => 'lebih dari 60 th',
                                                            'kurang dari 24 th' => 'kurang dari 24 th',
                                                        ];
                                                    ...
                                                    <select disabled class="form-control border-0 bg-white text-dark"
                                                        ...
                                                        <option value="">-- Pilih Usia --</option>
                                                        @foreach ($usiaNasabahOptions as $value => $label)
                                                            <option value="{{ $value }}"
                                                                {{ $selectedUsiaNasabah == $value ? 'selected' : '' }}>
                                                                {{ $label }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="tab-pane fade" id="nav-3" role="tabpanel"
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('murabahah.limac.character.edit', $pengajuan->kode_pengajuan) }}"
                                        ...
                                        <div class="tab-pane fade" id="nav-5" role="tabpanel"
                                            ...
                                            <h6 class="text-danger border-bottom pb-2">Pembiayaan Berdasarkan Gross
                                                Income</h6>

                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga beli Bank/ Pembiayaan</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_pembiayaan">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_harga_beli_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6">
                                                    <input disabled type="text"
                                                        class="form-control border-0 bg-white text-dark font-weight-bold text-left p-0 m-0"
                                                        id="grossincome_jangka_waktu_pembiayaan"
                                                        name="grossincome_jangka_waktu_pembiayaan"
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Jangka Waktu Pembiayaan
                                                    (Bulan)</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_jangka_waktu_bulan">12
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Angsuran Per Bulan</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_angsuran_per_bulan">Rp.
                                                    0,00</div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6 font-weight-bold">Repayment Capacity (kemampuan gaji
                                                    ...
                                                    angsuran)</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_repayment">1</div>
                                            </div>
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga beli Bank/ Pembiayaan</div>
                                                <div class="col-6 text-left font-weight-bold" id="netincome_pembiayaan">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga Jual Bank</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="netincome_harga_beli_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <h6 class="text-danger border-bottom pb-2">Pembiayaan Berdasarkan
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga beli Bank/ Pembiayaan</div>
                                                <div class="col-6 text-left font-weight-bold" id="terkecil_pembiayaan">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Margin Bank</div>
                                                <div class="col-6 text-left font-weight-bold" id="terkecil_margin_bank">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga Jual Bank</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="terkecil_harga_beli_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6">
                                                    <input disabled type="text"
                                                        class="form-control border-0 bg-white text-dark font-weight-bold text-left p-0 m-0"
                                                        id="terkecil_jangka_waktu_pembiayaan"
                                                        name="terkecil_jangka_waktu_pembiayaan"
                                                        value="{{ ': ' . $pengajuan_pembiayaan->permohonan_jangka_waktu_pembiayaan . ' tahun' }}"
                                                        oninput="hitungHargaJual()">
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Jangka Waktu Pembiayaan
                                                    (Bulan)</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="terkecil_jangka_waktu_bulan">12
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="terkecil_angsuran_per_bulan">Rp.
                                                    0,00</div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6 font-weight-bold">Repayment Capacity (kemampuan gaji
                                                    nasabah membayar
                                                    angsuran)</div>
                                                <div class="col-6 text-left font-weight-bold" id="terkecil_repayment">1
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="nav-6" role="tabpanel"
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga beli Bank/ Pembiayaan</div>
                                                <div class="col-6 text-left font-weight-bold" id="analis_pembiayaan">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Margin Bank</div>
                                                <div class="col-6 text-left font-weight-bold" id="analis_margin_bank">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6">
                                                    <input type="number" class="form-control text-left p-0 m-0"
                                                        id="analis_angsuran_per_bulan" name="analis_angsuran_per_bulan"
                                                        value="{{ old('analis_angsuran_per_bulan', $pengajuan->analis_angsuran_per_bulan ?? '') }}"
                                                        oninput="hitungHargaJual()">
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">

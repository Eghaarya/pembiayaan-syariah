                                        ...
                                        <div class="tab-pane fade" id="nav-5" role="tabpanel"
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_harga_beli_bank">
                                                    Rp. 0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="grossincome_harga_jual_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga Jual Bank</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="netincome_harga_jual_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">Harga Jual Bank</div>
                                                <div class="col-6 text-left font-weight-bold"
                                                    id="terkecil_harga_jual_bank">Rp.
                                                    0,00
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-6">
                                                    <input type="hidden" id="analis_harga_jual_bank_from_db"
                                                        value="{{ $pengajuan->analis_harga_jual_bank ? '1' : '0' }}">

                                                    <input type="number" step="0.01"
                                                        class="form-control font-weight-bold text-left p-0 pl-2 py-1 m-0"
                                                        id="analis_harga_jual_bank" name="analis_harga_jual_bank"
                                                        value="{{ old('analis_harga_jual_bank', $pengajuan->analis_harga_jual_bank ?? '') }}">
                                                </div>
                                            </div>
                                            <div class="row g-3 mb-3">
                                                <div class="col-6">

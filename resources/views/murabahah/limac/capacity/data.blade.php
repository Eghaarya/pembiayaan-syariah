                                    ...
                                    <tbody>
                                        @forelse ($murabahah_limac_capacity as $index => $murabahah)
                                            <tr class="text-center">
                                                ...
                                                @for ($i = 1; $i <= 3; $i++)
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"jenis_pinjaman_nasabah_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"limit_nasabah_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"jangka_waktu_nasabah_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ number_format($murabahah->{"sisa_hutang_nasabah_{$i}"}, 2, ',', '.') }}
                                                    </td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"kreditur_nasabah_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"agunan_nasabah_{$i}"} }}</td>
                                                @endfor

                                                @for ($i = 1; $i <= 3; $i++)
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"jenis_pinjaman_pasangan_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"limit_pasangan_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"jangka_waktu_pasangan_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ number_format($murabahah->{"sisa_hutang_pasangan_{$i}"}, 2, ',', '.') }}
                                                    </td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"kreditur_pasangan_{$i}"} }}</td>
                                                    <td class="align-middle text-wrap p-1">
                                                        {{ $murabahah->{"agunan_pasangan_{$i}"} }}</td>
                                                @endfor
                                                ...
                                                <td class="align-middle text-wrap p-1">
                                                    {{ $murabahah->jangka_waktu_pembiayaan }}</td>

        ...
        <div class="pcoded-wrapper">
            ...
            'lainnya' => 'Lainnya',
                                            ...
                                            <div class="row g-3 mb-3">
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    <label class="form-label fw-bold d-block">Apakah nasabah
                                                        memiliki rekening di bank ini?</label>
                                                    @php
                                                        $punyaOptions = ['Tidak', 'Iya Punya'];
                                                        $selectedPunya = preg_replace(
                                                            '/\s*\(.*?\)/',
                                                            '',
                                                            old(
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    <label class="form-label fw-bold d-block">Tahun Menjadi
                                                        Nasabah</label>
                                                    @php
                                                        $tahunOptions = ['<1 Tahun', '1-3 Tahun', '>3 Tahun'];
                                                        $selectedTahun = preg_replace(
                                                            '/\s*\(.*?\)/',
                                                            '',
                                                            old(
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    <label class="form-label fw-bold d-block">Mutasi Rekening Di
                                                        Bank UMSIDA Syariah / Performance Sebagai Nasabah Bank UMSIDA
                                                        Syariah</label>
                                                    @php
                                                        $mutasiOptions = [
                                                            'Mutasi Rekening Aktif',
                                                            'Mutasi Rekening Tidak Aktif',
                                                        ];
                                                        $selectedMutasi = preg_replace(
                                                            '/\s*\(.*?\)/',
                                                            '',
                                                            old(
                                                        ...
                                                        @foreach ($pengajuan_checking_nasabah as $i => $item)
                                                            <tr>
                                                                ...
                                                                <td class="p-1"><input type="date"
                                                                        ...
                                                                        value="{{ \Carbon\Carbon::parse($item->tanggal_realisasi_nasabah)->format('Y-m-d') }}"
                                                                        class="form-control text-center align-middle"></td>
                                                                <td class="p-1"><input type="date"
                                                                        name="id_checking_nasabah[{{ $i }}][tanggal_jatuh_tempo]"
                                                                        value="{{ \Carbon\Carbon::parse($item->tanggal_jatuh_tempo_nasabah)->format('Y-m-d') }}"
                                                                        class="form-control text-center align-middle"></td>
                                                                <td class="p-1">
                                                                    <select
                                                        ...
                                                        @foreach ($pengajuan_checking_pasangan as $i => $item)
                                                            <tr>
                                                                ...
                                                                <td class="p-1"><input type="date"
                                                                        ...
                                                                        value="{{ optional($item->tanggal_realisasi_pasangan)->format('Y-m-d') }}"
                                                                        class="form-control text-center align-middle"></td>
                                                                <td class="p-1"><input type="date"
                                                                        name="id_checking_pasangan[{{ $i }}][tanggal_jatuh_tempo]"
                                                                        value="{{ optional($item->tanggal_jatuh_tempo_pasangan)->format('Y-m-d') }}"
                                                                        class="form-control text-center align-middle"></td>
                                                                <td class="p-1">
                                                                    <select

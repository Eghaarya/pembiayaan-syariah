                ...
                <div class="card card-social">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-3 mt-2" id="harga_jual_barang">: <span class="font-weight-bold">Rp
                                            {{ number_format($pengajuan->keputusan_harga_jual_barang, 0, ',', '.') }}</span>
                                    </div>
                                    ...
                                    <div class="col-md-3 mt-2" id="urbun_uangmuka">: <span class="font-weight-bold">Rp
                                            {{ number_format($pengajuan->keputusan_urbun_uangmuka, 0, ',', '.') }}</span>
                                    </div>
                    ...
                    <div class="card-block border-bottom p-3">
                        @php
                            ...
                            // Data dasar
                            $hargaBeliBank = floatval($pengajuan->keputusan_harga_beli_bank);
                            $jangkaTahun = floatval($pengajuan->keputusan_jangka_waktu_pembiayaan);
                            $jangkaBulan = $jangkaTahun * 12;

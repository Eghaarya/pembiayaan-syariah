                    ...
                    <div class="card-block border-bottom">
                        <div class="row">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th colspan="15" class="align-middle p-2">Scooring Collateral Bermotor
                                            </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        @forelse ($multiguna_limac_collateralbermotor as $index => $item)
                                            <tr>
                                                <td class="text-center align-middle text-wrap p-2">
                                                    <a href="{{ route('multiguna.limac.collateralbermotor.edit', $item->kode_pengajuan) }}"
                                                        class="text-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                </td>
                                                <td class="text-center align-middle text-wrap p-2">
                                                    {{ $multiguna_limac_collateralbermotor->firstItem() + $index }}</td>
                            ...
                            <div class="d-flex justify-content-start mt-3">
                                {{ $multiguna_limac_collateralbermotor->links() }}
                            </div>
                        </div>

                                            ...
                                            <div class="row g-3 mb-3">
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input disabled type="text"
                                                        class="form-control border-0 bg-white text-dark" id="jenis_akad"
                                                        name="jenis_akad"
                                                        value="{{ old('jenis_akad', $pengajuan_pembiayaan->jenis_akad ?? '--') }}">
                                                </div>
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input disabled type="text"
                                                        ...
                                                        id="jenis_pembiayaan" name="jenis_pembiayaan"
                                                        value="{{ old('jenis_pembiayaan', $pengajuan_pembiayaan->jenis_pembiayaan ?? '--') }}">
                                                </div>
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <select disabled class="form-control border-0 bg-white text-dark"
                                                        id="tujuan_penggunaan" name="tujuan_penggunaan">
                                                        @php
                                                            $options = [
                                                                '--',
                                                            ...
                                                            $selected = old(
                                                                'tujuan_penggunaan',
                                                                $pengajuan_pembiayaan->tujuan_penggunaan ?? '--',
                                                            );
                                                        @endphp
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <input disabled type="text"
                                                        class="form-control border-0 bg-white text-dark"
                                                        id="harga_beli_bank" name="harga_beli_bank"
                                                        value="{{ old('harga_beli_bank', $pengajuan_pembiayaan->harga_beli_bank ?? '--') }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mt-2">
                                                    ...
                                                    <input disabled type="text"
                                                        ...
                                                        value="{{ old('jangka_waktu_pembiayaan', $pengajuan_pembiayaan->jangka_waktu_pembiayaan ?? '--') }}">
                                                </div>
                                                ...
                                                <div class="col-md-3 mt-2">
                                                    ...
                                                    <input disabled type="text"
                                                        class="form-control border-0 bg-white text-dark" id="margin_bank"
                                                        name="margin_bank"
                                                        value="{{ old('margin_bank', $pengajuan_pembiayaan->margin_bank ?? '--') }}">
                                                </div>

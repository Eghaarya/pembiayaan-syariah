            ...
            <div class="pcoded-content">
                <div class="card card-social">
                    <div class="card-block border-bottom">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('multiguna.dokumentasi.update', $pengajuan->kode_pengajuan) }} "
                                    ...
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <button class="nav-link active" id="nav-1-tab" data-toggle="tab"
                                                ...
                                                aria-selected="true">Dokumentasi Multiguna</button>
                                        </div>
                                    </nav>
                                    <div class="tab-content p-3" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if ($pengajuan->$field)
                                                                <small class="form-text text-muted">
                                                                    File saat ini:
                                                                    <a href="{{ asset('storage/uploads/multiguna/' . $pengajuan->$field) }}"
                                                                ...
                                                                <a href="{{ asset('storage/uploads/multiguna/' . $pengajuan->$field) }}"
                                                                    target="_blank">
                                                                    <img src="{{ asset('storage/uploads/multiguna/' . $pengajuan->$field) }}"
                                                                        alt="{{ $label }} Preview"
                                            ...
                                            <h6 class="border-bottom text-danger pb-2">Dokumentasi Capacity</h6>
                                            <div class="row g-3 mb-3">
                                            ...
                                            <h6 class="border-bottom text-danger pb-2">Dokumentasi Collateral</h6>
                                            <div class="row g-3 mb-3">
                                                ...
                                                @php
                                                    $collateralFields = [
                                                        ...
                                                        'foto_jaminan_depan_kpm' =>
                                                            'Jika Agunan adalah rumah/tanah/ruko/rukan dan agunan kendaranan bermotor maka foto jaminan kendaraan depan',
                                                        'foto_jaminan_samping_kpm' =>
                                                            'Jika Agunan adalah rumah/tanah/ruko/rukan dan agunan kendaranan bermotor maka foto jaminan kendaraan samping',
                                                        'foto_jaminan_atas_kpm' =>
                                                            'Jika Agunan adalah rumah/tanah/ruko/rukan dan agunan kendaranan bermotor maka foto jaminan kendaraan atas',
                                                        'foto_jaminan_rangka_mesin_kpm' =>
                                                            'Jika Agunan adalah rumah/tanah/ruko/rukan dan agunan kendaranan bermotor maka foto jaminan kendaraan rangka mesin ',
                                                    ];
                                                @endphp

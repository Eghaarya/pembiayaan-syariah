                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table border table-bordered text-center">
                                    <thead>
                                        <tr>
                                            <th class="align-middle p-2">No.</th>
                                            <th class="align-middle p-2">Kode Pengajuan</th>
                                            <th class="align-middle p-2">Kode Nasabah</th>
                                            <th class="align-middle p-2">Nama Nasabah</th>
                                            <th class="align-middle bg-white p-2">Surat Persetujuan Pembiayaan</th>
                                            <th class="align-middle bg-white p-2">Dokumen Akad Pembiayaan</th>
                                            <th class="align-middle bg-white p-2">Surat Pencairan Pembiayaan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ route('multiguna.cetak.surat_persetujuan', $multiguna->kode_pengajuan) }}"
                                                        ...
                                                        <i class="fas fa-file-alt"></i> Surat Persetujuan
                                                    </a>
                                                </td>
                                                <td class="align-middle">

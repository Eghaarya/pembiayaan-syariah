...
<body contenteditable="true" spellcheck="false" class="bg-white text-dark">
    ...
    <div class="container p-5">
        ...
        <div>
            ...
            <p class="my-1">
                Menunjuk pada surat permohonan pembiayaan Multiguna Sauddara, dengan ini diberitahukan bahwa Bank
                Syariah UMSIDA dapat memberikan pembiayaan kepada nasabah dengan data :
            </p>
        </div>
        ...
        <div class="form-group row align-items-center my-0 py-0">
            ...
            <div class="col-1 text-right px-0">:</div>
            <div class="col-9">
                <input type="text" class="form-control p-0 bg-white text-danger border-0 font-weight-bold"
                    id="keputusan_jenis_pembiayaan" name="keputusan_jenis_pembiayaan"
                    value="{{ old('keputusan_jenis_pembiayaan', $pengajuan->keputusan_jenis_pembiayaan ?? '') }}">
        ...
        {{-- Biaya --}}
        <p class="font-weight-bold border-top pt-2">Biaya-biaya</p>
        {{-- 1. Administrasi --}}
        <div class="form-group row align-items-center my-0 py-0">

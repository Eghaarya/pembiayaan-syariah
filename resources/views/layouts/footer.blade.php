...
<script>
    ...
    function toggleTanggalPencairan() {
        ...
        if (!keputusanInput || !wrapper || !tanggalInput) return; // Cegah error jika tidak ada elemen
        ...
        if (keputusan === 'disetujui') {
            ...
            tanggalInput.value = ''; // Kosongkan isi tanggal saat bukan disetujui
        }
    }
    ...
    function hitungTotal() {
        ...
        hitungHargaJual(); // Panggil agar update harga jual
    }
    ...
    function kategoriHargaJual(prefix, pendapatan, angsuranPerBulan) {
        ...
        let pembiayaan = (1 + tahun) !== 0 ? hargaJual / (1 + tahun) : 0;
        ...
        setText('harga_beli_bank', hargaJual);
        setText('pembiayaan', pembiayaan);
